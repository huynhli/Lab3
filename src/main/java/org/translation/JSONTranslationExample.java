...
public class JSONTranslationExample {
    ...
    public String getCountryNameTranslation(String countryCode, String languageCode) {
        ...
        boolean found = false;
        for (Object eachArrayDict : jsonArray) {
            JSONObject eachArrayDictAsJSON = (JSONObject) eachArrayDict;
            if (eachArrayDictAsJSON.getString("alpha3").equals(countryCode)) {
                found = true;
                break;
            }
            counterForIndex += 1;
        ...
        if (!found) {
            ...
            JSONObject countryAsDict = jsonArray.getJSONObject(counterForIndex);
            return countryAsDict.getString(languageCode);
        }
    }
